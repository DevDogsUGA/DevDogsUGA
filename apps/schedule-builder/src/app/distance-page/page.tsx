  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex h-[calc(100vh-5rem)] flex-grow flex-col items-center justify-center pt-20 text-center">
        <div className="mb-12 flex items-center justify-center rounded-none border border-[#F8E6EA]/40 bg-[#F3EDED]/80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[4rem] sm:w-[40rem] sm:rounded-full md:h-[3rem]">
