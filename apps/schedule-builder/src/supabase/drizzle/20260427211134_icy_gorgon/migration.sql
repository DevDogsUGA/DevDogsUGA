...
CREATE TABLE "realtime"."messages_2026_04_26" (
	...
	"inserted_at" timestamp DEFAULT now(),
	"id" uuid DEFAULT gen_random_uuid(),
	CONSTRAINT "messages_2026_04_26_pkey" PRIMARY KEY("id","inserted_at")
);
--> statement-breakpoint
CREATE TABLE "realtime"."messages_2026_04_27" (
	...
	"inserted_at" timestamp DEFAULT now(),
	"id" uuid DEFAULT gen_random_uuid(),
	CONSTRAINT "messages_2026_04_27_pkey" PRIMARY KEY("id","inserted_at")
);
--> statement-breakpoint
CREATE TABLE "realtime"."messages_2026_04_28" (
	...
	"inserted_at" timestamp DEFAULT now(),
	"id" uuid DEFAULT gen_random_uuid(),
	CONSTRAINT "messages_2026_04_28_pkey" PRIMARY KEY("id","inserted_at")
);
--> statement-breakpoint
CREATE TABLE "realtime"."messages_2026_04_29" (
	...
	"inserted_at" timestamp DEFAULT now(),
	"id" uuid DEFAULT gen_random_uuid(),
	CONSTRAINT "messages_2026_04_29_pkey" PRIMARY KEY("id","inserted_at")
);
--> statement-breakpoint
CREATE TABLE "realtime"."messages_2026_04_30" (
	...
	"inserted_at" timestamp DEFAULT now(),
	"id" uuid DEFAULT gen_random_uuid(),
	CONSTRAINT "messages_2026_04_30_pkey" PRIMARY KEY("id","inserted_at")
);
--> statement-breakpoint
...
CREATE INDEX "messages_2026_04_26_inserted_at_topic_idx" ON "realtime"."messages_2026_04_26" ("inserted_at" DESC,"topic") WHERE ((extension = 'broadcast'::text) AND (private IS TRUE));--> statement-breakpoint
CREATE INDEX "messages_2026_04_27_inserted_at_topic_idx" ON "realtime"."messages_2026_04_27" ("inserted_at" DESC,"topic") WHERE ((extension = 'broadcast'::text) AND (private IS TRUE));--> statement-breakpoint
CREATE INDEX "messages_2026_04_28_inserted_at_topic_idx" ON "realtime"."messages_2026_04_28" ("inserted_at" DESC,"topic") WHERE ((extension = 'broadcast'::text) AND (private IS TRUE));--> statement-breakpoint
CREATE INDEX "messages_2026_04_29_inserted_at_topic_idx" ON "realtime"."messages_2026_04_29" ("inserted_at" DESC,"topic") WHERE ((extension = 'broadcast'::text) AND (private IS TRUE));--> statement-breakpoint
CREATE INDEX "messages_2026_04_30_inserted_at_topic_idx" ON "realtime"."messages_2026_04_30" ("inserted_at" DESC,"topic") WHERE ((extension = 'broadcast'::text) AND (private IS TRUE));--> statement-breakpoint
