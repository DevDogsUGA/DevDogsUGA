...
export const relations = defineRelations(schema, (r) => ({
  ...
  icebergNamespacesInStorage: {
    bucketsAnalyticsInStorage: r.one.bucketsAnalyticsInStorage({
      ...
      alias:
        "icebergNamespacesInStorage_catalogId_bucketsAnalyticsInStorage_id",
    }),
    bucketsAnalyticsInStorages: r.many.bucketsAnalyticsInStorage({
      alias:
        "bucketsAnalyticsInStorage_id_icebergNamespacesInStorage_id_via_icebergTablesInStorage",
    }),
  },
  bucketsAnalyticsInStorage: {
    ...
    icebergNamespacesInStoragesViaIcebergTablesInStorage:
      r.many.icebergNamespacesInStorage({
        from: r.bucketsAnalyticsInStorage.id.through(
          r.icebergTablesInStorage.catalogId,
        ),
        to: r.icebergNamespacesInStorage.id.through(
          r.icebergTablesInStorage.namespaceId,
        ),
        alias:
          "bucketsAnalyticsInStorage_id_icebergNamespacesInStorage_id_via_icebergTablesInStorage",
      }),
