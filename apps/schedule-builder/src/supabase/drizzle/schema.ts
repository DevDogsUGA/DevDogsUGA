import { pgSchema, pgTable, text, bigserial, uuid, bigint, varchar, integer, timestamp, pgEnum, customType, json, jsonb, boolean, inet, smallint, index, uniqueIndex, foreignKey, primaryKey, unique, check, doublePrecision, numeric } from "drizzle-orm/pg-core"
...
export const messages20260428InRealtime = realtime.table("messages_2026_04_28", {
	topic: text().notNull(),
	extension: text().notNull(),
	payload: jsonb(),
	event: text(),
	...
	primaryKey({ columns: [table.id, table.insertedAt], name: "messages_2026_04_28_pkey"}),
	index("messages_2026_04_28_inserted_at_topic_idx").using("btree", table.insertedAt.desc().nullsFirst(), table.topic.asc().nullsLast()).where(sql`((extension = 'broadcast'::text) AND (private IS TRUE))`),
]);

export const messages20260429InRealtime = realtime.table("messages_2026_04_29", {
	topic: text().notNull(),
	extension: text().notNull(),
	payload: jsonb(),
	event: text(),
	...
	primaryKey({ columns: [table.id, table.insertedAt], name: "messages_2026_04_29_pkey"}),
	index("messages_2026_04_29_inserted_at_topic_idx").using("btree", table.insertedAt.desc().nullsFirst(), table.topic.asc().nullsLast()).where(sql`((extension = 'broadcast'::text) AND (private IS TRUE))`),
]);

export const messages20260430InRealtime = realtime.table("messages_2026_04_30", {
	topic: text().notNull(),
	extension: text().notNull(),
	payload: jsonb(),
	event: text(),
	...
	primaryKey({ columns: [table.id, table.insertedAt], name: "messages_2026_04_30_pkey"}),
	index("messages_2026_04_30_inserted_at_topic_idx").using("btree", table.insertedAt.desc().nullsFirst(), table.topic.asc().nullsLast()).where(sql`((extension = 'broadcast'::text) AND (private IS TRUE))`),
]);

export const messages20260501InRealtime = realtime.table("messages_2026_05_01", {
	topic: text().notNull(),
	extension: text().notNull(),
	payload: jsonb(),
	event: text(),
	...
	primaryKey({ columns: [table.id, table.insertedAt], name: "messages_2026_05_01_pkey"}),
	index("messages_2026_05_01_inserted_at_topic_idx").using("btree", table.insertedAt.desc().nullsFirst(), table.topic.asc().nullsLast()).where(sql`((extension = 'broadcast'::text) AND (private IS TRUE))`),
]);

export const messages20260502InRealtime = realtime.table("messages_2026_05_02", {
	topic: text().notNull(),
	extension: text().notNull(),
	payload: jsonb(),
	event: text(),
	...
	primaryKey({ columns: [table.id, table.insertedAt], name: "messages_2026_05_02_pkey"}),
	index("messages_2026_05_02_inserted_at_topic_idx").using("btree", table.insertedAt.desc().nullsFirst(), table.topic.asc().nullsLast()).where(sql`((extension = 'broadcast'::text) AND (private IS TRUE))`),
]);

export const messages20260503InRealtime = realtime.table("messages_2026_05_03", {
	topic: text().notNull(),
	extension: text().notNull(),
	payload: jsonb(),
	event: text(),
	...
	primaryKey({ columns: [table.id, table.insertedAt], name: "messages_2026_05_03_pkey"}),
	index("messages_2026_05_03_inserted_at_topic_idx").using("btree", table.insertedAt.desc().nullsFirst(), table.topic.asc().nullsLast()).where(sql`((extension = 'broadcast'::text) AND (private IS TRUE))`),
]);

export const messages20260504InRealtime = realtime.table("messages_2026_05_04", {
	topic: text().notNull(),
	extension: text().notNull(),
	payload: jsonb(),
	event: text(),
	...
	primaryKey({ columns: [table.id, table.insertedAt], name: "messages_2026_05_04_pkey"}),
	index("messages_2026_05_04_inserted_at_topic_idx").using("btree", table.insertedAt.desc().nullsFirst(), table.topic.asc().nullsLast()).where(sql`((extension = 'broadcast'::text) AND (private IS TRUE))`),
]);
