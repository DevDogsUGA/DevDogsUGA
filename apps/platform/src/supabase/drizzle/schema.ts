import { pgSchema, pgTable, uuid, text, varchar, bigserial, bigint, integer, pgEnum, customType, timestamp, json, jsonb, boolean, inet, smallint, index, uniqueIndex, foreignKey, primaryKey, unique, check, pgPolicy, doublePrecision, numeric } from "drizzle-orm/pg-core"
