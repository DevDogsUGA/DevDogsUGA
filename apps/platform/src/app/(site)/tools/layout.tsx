 ...
 * index. The `noindex` is for the case that redirect does not cover — a URL
 * that reached an index some other way — and it is inherited by every page in
 * the segment, so a tool added later is covered without a second decision.
 *
