 ...
 * landed, so this reports what happened rather than saying "done". The refusals
 * are on the page in full, because a count of them answers the wrong question.
 */
                    ...
                    <p>
                      ...
                      <strong className="font-semibold text-white">
                        {/* `formatEventDateTime` rather than a bare
                            ...
                            zone, the one an officer is thinking in anyway. */}
    ...
    <ConsoleCard.Root id="sync-report">
      ...
      <ConsoleCard.Content>
        <dl className="grid grid-cols-2 gap-x-6 gap-y-1 sm:grid-cols-3">
          ...
          {/* Shown only when it happened, like accounts created. This is the
              one irreversible thing a pass does, so a standing "0" would train
              an officer to stop reading it. */}
 ...
 * officer who made the edit will see it. This copy exists because the console
 * is where somebody debugging "why did nothing change" looks, and asking them
 * to find the row in the base first is the wrong order.
 */
