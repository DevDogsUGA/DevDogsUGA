...
export default function HeroSection() {
  ...
  // Shares the reveal tween with SectionBackground so the content mask and the
  // painted background trace the same diagonal on every frame. Before hydration
  // the section stays unclipped; the wrapper's rounded overflow covers for it.
  useSectionSlope(sectionRef, (W, H, S) => {
