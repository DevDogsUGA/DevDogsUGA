/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=production --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 3c84b7c7a15bf2e7a5187265fe2d6480)
// Runtime types generated with workerd@1.20260820.1 2026-07-22 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	EMAIL: SendEmail;
	ATTENDANCE_RATE_LIMITER: RateLimit;
