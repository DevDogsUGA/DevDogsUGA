 ...
 * \`tipBottom\` are where a vertical line through \`x\` crosses the outline. The
 * pin's point has to land there to touch the wall beneath it rather than the
 * corner of a box drawn around the building.
 */
