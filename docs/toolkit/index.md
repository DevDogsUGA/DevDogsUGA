...
| Boot, migrate or reset a database    | [**`pnpm sb`**](/docs/toolkit/guides/sb) — four commands over your local stack, the linked Supabase project, or a team sandbox, plus `stop` and `restart` for your own   |
