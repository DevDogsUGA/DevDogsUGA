...
export type Database = {
    ...
    platform: {
        ...
        Enums: {
            ...
            feedbackType: "bug_report" | "feature_request" | "design_feedback" | "performance" | "content_issue" | "other";
...
export declare const Constants: {
    ...
    readonly platform: {
        readonly Enums: {
            ...
            readonly feedbackSeverity: readonly ["low", "medium", "high"];
            readonly feedbackStatus: readonly ["open", "in_review", "resolved", "dismissed"];
            readonly feedbackType: readonly ["bug_report", "feature_request", "design_feedback", "performance", "content_issue", "other"];
            readonly filerAction: readonly ["warn", "suspend", "no_action"];
            readonly graduationSemester: readonly ["spring", "summer", "fall"];
            readonly oauthRegistrationType: readonly ["development", "production"];
            readonly reportStatus: readonly ["unverified", "pending", "resolved", "dismissed"];
    ...
    readonly schedule_builder: {
        readonly Enums: {
            readonly locationStatus: readonly ["TBA", "NCRR", "RESERVED"];
        };
    };
    readonly storage: {
        readonly Enums: {
